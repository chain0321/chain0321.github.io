// EasySpeech 2.4.0, MIT; see LICENSE.easy-speech.txt and PATCHES.md.
/**
 * @module EasySpeech
...
const patches = {};
// Retain the active utterance until end, error, or cancellation.
...
EasySpeech.speak = ({ text, voice, pitch, rate, volume, force, infiniteResume, noStop, ...handlers }) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Preserve the user gesture on iOS; do not defer this call.
